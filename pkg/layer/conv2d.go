...
func (conv *Conv2D) Build() error {
	...
	conv.calOutShape()
	conv.PreLayer = nil
	conv.Weights = tensor.NewWeigthTensor(conv.OutputShape[2], conv.InputShape[2], conv.KernelWidth, conv.KernelHeight)
	conv.MWeights = tensor.NewZeroTensor(conv.OutputShape[2], conv.InputShape[2], conv.KernelWidth, conv.KernelHeight)
	conv.Bias = tensor.NewWeigthTensor(conv.OutputShape...)
